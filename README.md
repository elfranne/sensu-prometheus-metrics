...
prior to `# sensu-prometheus-metrics` from the generated README file, and add additional context about the
...
The sensu-prometheus-metrics is a [Sensu Check][6] that ...
...
If you're using an earlier version of sensuctl, you can find the asset on the [Bonsai Asset Index][https://bonsai.sensu.io/assets/elfranne/sensu-prometheus-metrics].
...
metadata:
  ...
  namespace: default
spec:
  command: sensu-prometheus-metrics --example example_arg
  subscriptions:
  - system
  runtime_assets:
...
[4]: https://github.com/elfranne/sensu-prometheus-metrics/blob/master/.github/workflows/release.yml
[5]: https://github.com/elfranne/sensu-prometheus-metrics/actions
